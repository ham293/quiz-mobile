...
| 版本 | 说明 | 下载 |
| --- | --- | --- |
| `app-release.apk`（6.0 MB） | **推荐**，v1.2.4 | [Release 页面](https://github.com/ham293/quiz-mobile/releases/latest) 或 [直接下载](https://github.com/ham293/quiz-mobile/releases/download/v1.2.4/app-release.apk) |
| `app-debug.apk`（7.1 MB） | 带调试信息，装不上时换这个试试 | [直接下载](https://github.com/ham293/quiz-mobile/releases/download/v1.2.4/app-debug.apk) |

> **手机网络打不开 github.com 下载链接时**（国内常见），在下载地址前面加一个加速前缀即可，例如：
> `https://ghproxy.net/https://github.com/ham293/quiz-mobile/releases/download/v1.2.4/app-release.apk`
...
3. **下载安装**：
   ...
   - 更方便的做法：打 tag 并推送，工作流会把 APK 直接发布到 **Releases**（本项目已发布 v1.2.4）：
     ```bash
